...
(function () {
  ...
  const DICT = {
    ...
    // ---- Phase 2.5: Sales Intelligence ----
    "nav.salesIntel": { ar: "ذكاء المبيعات", en: "Sales Intelligence" },
    "si.title": { ar: "ذكاء المبيعات", en: "Sales Intelligence" },
    "si.subtitle": { ar: "ماذا بيع؟ أين؟ عبر أي قناة؟ وما الذي ينمو أو ينخفض؟", en: "What sold, where, through which channel, and what is growing or falling?" },
    "si.period": { ar: "الفترة", en: "Period" },
    "si.grain": { ar: "التدرّج", en: "Grain" },
    "si.branch": { ar: "الفرع", en: "Branch" },
    "si.channel": { ar: "القناة", en: "Channel" },
    "si.category": { ar: "الفئة", en: "Category" },
    "si.all": { ar: "الكل", en: "All" },
    "si.grain.day": { ar: "يومي", en: "Daily" },
    "si.grain.week": { ar: "أسبوعي", en: "Weekly" },
    "si.grain.month": { ar: "شهري", en: "Monthly" },
    "si.grain.quarter": { ar: "ربع سنوي", en: "Quarterly" },
    "si.grain.year": { ar: "سنوي", en: "Yearly" },
    "si.net": { ar: "صافي المبيعات", en: "Net sales" },
    "si.gross": { ar: "إجمالي المبيعات", en: "Gross sales" },
    "si.growth": { ar: "النمو", en: "Growth" },
    "si.tx": { ar: "الفواتير", en: "Transactions" },
    "si.aov": { ar: "متوسط السلة", en: "Average basket" },
    "si.returns": { ar: "المرتجعات", en: "Returns" },
    "si.discounts": { ar: "الخصومات", en: "Discounts" },
    "si.trend": { ar: "اتجاه المبيعات", en: "Sales trend" },
    "si.byBranch": { ar: "المبيعات حسب الفروع", en: "Sales by branch" },
    "si.byChannel": { ar: "المبيعات حسب القنوات", en: "Sales by channel" },
    "si.products": { ar: "ذكاء المنتجات", en: "Product intelligence" },
    "si.categories": { ar: "الفئات", en: "Categories" },
    "si.product": { ar: "المنتج", en: "Product" },
    "si.qty": { ar: "الكمية", en: "Quantity" },
    "si.share": { ar: "المساهمة", en: "Share" },
    "si.signals": { ar: "إشارات المبيعات", en: "Sales signals" },
    "si.evidence": { ar: "الدليل", en: "Evidence" },
    "si.rule": { ar: "القاعدة", en: "Rule" },
    "si.impact": { ar: "الأثر", en: "Impact" },
    "si.toDecision": { ar: "حوّل لقرار", en: "Make a decision" },
    "si.created": { ar: "تم إنشاء القرار والمهمة ✓", en: "Decision and task created ✓" },
    "si.owner": { ar: "المسؤول", en: "Owner" },
    "si.due": { ar: "الموعد", en: "Due" },
    "si.create": { ar: "إنشاء", en: "Create" },
    "si.compare": { ar: "المقارنة", en: "Comparison" },
    "si.prev": { ar: "الفترة السابقة", en: "Previous period" },
    "si.yoy": { ar: "نفس الفترة العام الماضي", en: "Same period last year" },
    "si.unavailable": { ar: "غير متاح", en: "Unavailable" },
    "si.discountAnalysis": { ar: "تحليل الخصومات", en: "Discount analysis" },
    "si.withDiscount": { ar: "مبيعات بخصم", en: "Sales with discount" },
    "si.withoutDiscount": { ar: "مبيعات بلا خصم", en: "Sales without discount" },
    "si.returnsAnalysis": { ar: "تحليل المرتجعات", en: "Returns analysis" },
    "si.rate": { ar: "النسبة", en: "Rate" },
    "si.topBranches": { ar: "أعلى الفروع", en: "Top branches" },
    "si.topProducts": { ar: "أعلى المنتجات", en: "Top products" },
    "si.empty": { ar: "لا توجد بيانات مبيعات تفصيلية بعد. ارفع ملف المبيعات من مركز البيانات.", en: "No detailed sales data yet. Upload a sales file from the Data Center." },
    "si.error": { ar: "تعذّر تحميل ذكاء المبيعات.", en: "Could not load sales intelligence." },
    "si.denied": { ar: "ليست لديك صلاحية لهذه الصفحة.", en: "You don't have permission for this page." },
    "si.noDimension": { ar: "لا توجد بيانات لهذا البُعد", en: "No data for this dimension" },
    "si.quality": { ar: "جودة البيانات", en: "Data quality" },
    "si.estimate": { ar: "تقديري", en: "Estimate" },
    "si.onlyOwner": { ar: "إنشاء القرارات للمالك فقط", en: "Only the owner can create decisions" },

    // ---- Phase 2.4: Data Center ----
    "nav.dataCenter": { ar: "مركز البيانات", en: "Data Center" },
    "dc.title": { ar: "مركز البيانات", en: "Data Center" },
    "dc.subtitle": { ar: "ارفع بيانات وحداتك وتحقق من جودتها قبل اعتمادها", en: "Upload your module data and check its quality before importing" },
    "dc.upload": { ar: "رفع بيانات", en: "Upload data" },
    "dc.datasets": { ar: "الملفات المرفوعة", en: "Datasets" },
    "dc.type": { ar: "نوع البيانات", en: "Data type" },
    "dc.file": { ar: "الملف", en: "File" },
    "dc.period": { ar: "الفترة", en: "Period" },
    "dc.branches": { ar: "الفروع", en: "Branches" },
    "dc.rows": { ar: "الصفوف", en: "Rows" },
    "dc.valid": { ar: "صالحة", en: "Valid" },
    "dc.rejected": { ar: "مرفوضة", en: "Rejected" },
    "dc.quality": { ar: "الجودة", en: "Quality" },
    "dc.status": { ar: "الحالة", en: "Status" },
    "dc.uploadedBy": { ar: "رفعها", en: "Uploaded by" },
    "dc.date": { ar: "التاريخ", en: "Date" },
    "dc.empty": { ar: "لا توجد ملفات مرفوعة بعد.", en: "No datasets uploaded yet." },
    "dc.error": { ar: "تعذّر تحميل البيانات.", en: "Could not load data." },
    "dc.denied": { ar: "ليست لديك صلاحية لمركز البيانات.", en: "You don't have permission for the Data Center." },
    "dc.step1": { ar: "١. اختر الملف", en: "1. Choose file" },
    "dc.step2": { ar: "٢. مراجعة الربط", en: "2. Review mapping" },
    "dc.step3": { ar: "٣. نتيجة التحقق", en: "3. Validation" },
    "dc.step4": { ar: "٤. الاعتماد", en: "4. Import" },
    "dc.choose": { ar: "اختر ملف CSV أو Excel", en: "Choose a CSV or Excel file" },
    "dc.preview": { ar: "معاينة وتحقق", en: "Preview and validate" },
    "dc.mapping": { ar: "ربط الأعمدة", en: "Column mapping" },
    "dc.column": { ar: "العمود في ملفك", en: "Your column" },
    "dc.field": { ar: "الحقل في نبّاه", en: "NABBAH field" },
    "dc.unmapped": { ar: "أعمدة لم تُطابق (ستُتجاهل)", en: "Unmapped columns (ignored)" },
    "dc.missingReq": { ar: "حقول مطلوبة ناقصة", en: "Missing required fields" },
    "dc.sample": { ar: "عينة من الصفوف الصالحة", en: "Sample of valid rows" },
    "dc.errors": { ar: "الصفوف المرفوضة وأسبابها", en: "Rejected rows and reasons" },
    "dc.row": { ar: "الصف", en: "Row" },
    "dc.reason": { ar: "السبب", en: "Reason" },
    "dc.import": { ar: "اعتماد الصفوف الصالحة", en: "Import valid rows" },
    "dc.imported": { ar: "تم الاعتماد ✓", en: "Imported ✓" },
    "dc.blocked": { ar: "جودة البيانات غير كافية للاعتماد. صحّح الأخطاء وأعد الرفع.", en: "Data quality is too low to import. Fix the errors and re-upload." },
    "dc.gate.ALLOW": { ar: "البيانات سليمة", en: "Data is sound" },
    "dc.gate.QUALIFY": { ar: "مقبولة مع تحفظات", en: "Acceptable with reservations" },
    "dc.gate.BLOCK": { ar: "غير صالحة للاعتماد", en: "Not importable" },
    "dc.status.processing": { ar: "قيد المعالجة", en: "Processing" },
    "dc.status.validated": { ar: "تم التحقق", en: "Validated" },
    "dc.status.imported": { ar: "معتمدة", en: "Imported" },
    "dc.status.partial": { ar: "معتمدة جزئياً", en: "Partially imported" },
    "dc.status.rejected": { ar: "مرفوضة", en: "Rejected" },
    "dc.lineage": { ar: "مصدر البيانات", en: "Data source" },
    "dc.detail": { ar: "تفاصيل الملف", en: "Dataset detail" },
    "dc.close": { ar: "إغلاق", en: "Close" },
    "dc.noPermissionUpload": { ar: "الرفع للمالك والمحاسب فقط.", en: "Uploading is for the owner and accountant only." },
    "dc.uploading": { ar: "جارٍ الرفع والتحقق…", en: "Uploading and validating…" },
    "dc.selectType": { ar: "اختر نوع البيانات أولاً", en: "Choose the data type first" },
    "dc.total": { ar: "إجمالي الملفات", en: "Datasets" },
    "dc.importedCount": { ar: "معتمدة", en: "Imported" },
    "dc.avgQuality": { ar: "متوسط الجودة", en: "Average quality" },

    // ---- Phase 2.3: actions, scenarios, decision memory, rules ----
    "nav.actions": { ar: "مركز الإجراءات", en: "Action Center" },
    "nav.scenarios": { ar: "السيناريوهات المحفوظة", en: "Saved Scenarios" },
    "act.title": { ar: "مركز الإجراءات", en: "Action Center" },
    "act.subtitle": { ar: "متابعة المهام الناتجة عن القرارات والتوصيات", en: "Track tasks created from decisions and recommendations" },
    "act.total": { ar: "إجمالي الإجراءات", en: "Total actions" },
    "act.open": { ar: "مفتوحة", en: "Open" },
    "act.overdue": { ar: "متأخرة", en: "Overdue" },
    "act.inProgress": { ar: "قيد التنفيذ", en: "In progress" },
    "act.completed": { ar: "مكتملة", en: "Completed" },
    "act.rate": { ar: "نسبة الإنجاز", en: "Completion rate" },
    "act.search": { ar: "ابحث في الإجراءات…", en: "Search actions…" },
    "act.allStatus": { ar: "كل الحالات", en: "All statuses" },
    "act.allOwners": { ar: "كل المسؤولين", en: "All owners" },
    "act.allBranches": { ar: "كل الفروع", en: "All branches" },
    "act.dueFrom": { ar: "من تاريخ", en: "Due from" },
    "act.dueTo": { ar: "إلى تاريخ", en: "Due to" },
    "act.sortDue": { ar: "الترتيب: الاستحقاق", en: "Sort: due date" },
    "act.sortPriority": { ar: "الترتيب: الأولوية", en: "Sort: priority" },
    "act.board": { ar: "لوحة", en: "Board" },
    "act.table": { ar: "جدول", en: "Table" },
    "act.empty": { ar: "لا توجد إجراءات بعد. أنشئ إجراءً من توصية في لوحة الذكاء التنفيذي.", en: "No actions yet. Create one from a recommendation on the Executive Intelligence panel." },
    "act.noMatch": { ar: "لا توجد نتائج تطابق الفلاتر.", en: "No actions match the filters." },
    "act.error": { ar: "تعذّر تحميل الإجراءات. تحقق من الاتصال وحاول مجدداً.", en: "Could not load actions. Check your connection and try again." },
    "act.denied": { ar: "ليست لديك صلاحية لعرض الإجراءات.", en: "You don't have permission to view actions." },
    "act.status.not_started": { ar: "لم يبدأ", en: "Not started" },
    "act.status.in_progress": { ar: "قيد التنفيذ", en: "In progress" },
    "act.status.blocked": { ar: "متعثر", en: "Blocked" },
    "act.status.completed": { ar: "مكتمل", en: "Completed" },
    "act.status.cancelled": { ar: "ملغى", en: "Cancelled" },
    "act.priority": { ar: "الأولوية", en: "Priority" },
    "act.owner": { ar: "المسؤول", en: "Owner" },
    "act.branch": { ar: "الفرع", en: "Branch" },
    "act.due": { ar: "الاستحقاق", en: "Due" },
    "act.progress": { ar: "الإنجاز", en: "Progress" },
    "act.expected": { ar: "الأثر المتوقع", en: "Expected impact" },
    "act.actual": { ar: "الأثر المقاس", en: "Measured impact" },
    "act.decision": { ar: "القرار المرتبط", en: "Linked decision" },
    "act.recommendation": { ar: "التوصية المرتبطة", en: "Linked recommendation" },
    "act.created": { ar: "أُنشئ", en: "Created" },
    "act.updated": { ar: "آخر تحديث", en: "Updated" },
    "act.save": { ar: "حفظ التغييرات", en: "Save changes" },
    "act.note": { ar: "أضف ملاحظة…", en: "Add a note…" },
    "act.notes": { ar: "الملاحظات", en: "Notes" },
    "act.history": { ar: "سجل التغييرات", en: "Change history" },
    "act.saved": { ar: "تم الحفظ ✓", en: "Saved ✓" },
    "act.closed": { ar: "هذا الإجراء مغلق ولا يمكن تعديله.", en: "This action is closed and cannot be edited." },
    "act.readonly": { ar: "عرض فقط — التعديل للمالك.", en: "View only — editing is for the owner." },
    "act.close": { ar: "إغلاق", en: "Close" },
    "act.estimate": { ar: "تقديري", en: "Estimate" },
    "act.noHistory": { ar: "لا توجد تغييرات مسجّلة.", en: "No recorded changes." },
    "scn.title": { ar: "السيناريوهات المحفوظة", en: "Saved Scenarios" },
    "scn.subtitle": { ar: "جرّب خططاً مالية واحفظها وأعد تشغيلها على أحدث بياناتك", en: "Test financial plans, save them, and re-run them on your latest data" },
    "scn.new": { ar: "سيناريو جديد", en: "New scenario" },
    "scn.count": { ar: "عدد السيناريوهات", en: "Scenarios" },
    "scn.ran": { ar: "مُشغّلة", en: "Run" },
    "scn.best": { ar: "أعلى أثر على الربح", en: "Best profit impact" },
    "scn.empty": { ar: "لا توجد سيناريوهات محفوظة. أنشئ أول سيناريو.", en: "No saved scenarios yet. Create your first one." },
    "scn.name": { ar: "اسم السيناريو", en: "Scenario name" },
    "scn.description": { ar: "الوصف", en: "Description" },
    "scn.type": { ar: "النوع", en: "Type" },
    "scn.type.growth": { ar: "نمو", en: "Growth" },
    "scn.type.cost_reduction": { ar: "خفض تكاليف", en: "Cost reduction" },
    "scn.type.pricing": { ar: "تسعير", en: "Pricing" },
    "scn.type.marketing": { ar: "تسويق", en: "Marketing" },
    "scn.type.custom": { ar: "مخصص", en: "Custom" },
    "scn.branch": { ar: "النطاق", en: "Scope" },
    "scn.allCompany": { ar: "الشركة كاملة", en: "Whole company" },
    "scn.basePeriod": { ar: "فترة الأساس (YYYY-MM)", en: "Base period (YYYY-MM)" },
    "scn.latest": { ar: "اتركها فارغة لآخر شهر", en: "Leave empty for the latest month" },
    "scn.assumptions": { ar: "الافتراضات (نسبة مئوية)", en: "Assumptions (%)" },
    "scn.a.revenue_growth_pct": { ar: "نمو المبيعات", en: "Revenue growth" },
    "scn.a.customer_change_pct": { ar: "تغيّر عدد العملاء", en: "Customer change" },
    "scn.a.aov_change_pct": { ar: "تغيّر متوسط الفاتورة", en: "Average invoice change" },
    "scn.a.expense_change_pct": { ar: "تغيّر المصروفات", en: "Expense change" },
    "scn.a.cogs_change_pct": { ar: "تغيّر تكلفة البضاعة", en: "COGS change" },
    "scn.a.payroll_change_pct": { ar: "تغيّر الرواتب", en: "Payroll change" },
    "scn.a.rent_change_pct": { ar: "تغيّر الإيجار", en: "Rent change" },
    "scn.a.marketing_change_pct": { ar: "تغيّر التسويق", en: "Marketing change" },
    "scn.save": { ar: "حفظ وتشغيل", en: "Save and run" },
    "scn.run": { ar: "إعادة التشغيل", en: "Re-run" },
    "scn.edit": { ar: "تعديل", en: "Edit" },
    "scn.delete": { ar: "حذف", en: "Delete" },
    "scn.confirmDelete": { ar: "أرشفة هذا السيناريو؟ يبقى في سجل التدقيق.", en: "Archive this scenario? It stays in the audit log." },
    "scn.cancel": { ar: "إلغاء", en: "Cancel" },
    "scn.compare": { ar: "الأساس مقابل السيناريو", en: "Baseline vs scenario" },
    "scn.metric": { ar: "المؤشر", en: "Metric" },
    "scn.baseline": { ar: "الأساس (فعلي)", en: "Baseline (actual)" },
    "scn.scenario": { ar: "السيناريو (تقديري)", en: "Scenario (estimate)" },
    "scn.difference": { ar: "الفرق", en: "Difference" },
    "scn.change": { ar: "التغيّر", en: "Change" },
    "scn.m.revenue": { ar: "المبيعات", en: "Revenue" },
    "scn.m.costs": { ar: "التكاليف", en: "Costs" },
    "scn.m.profit": { ar: "الربح", en: "Profit" },
    "scn.m.margin_pct": { ar: "الهامش %", en: "Margin %" },
    "scn.estimateNote": { ar: "نتائج تقديرية مبنية على افتراضاتك — ليست بيانات فعلية.", en: "Estimates based on your assumptions — not actual data." },
    "scn.error": { ar: "تعذّر تحميل السيناريوهات.", en: "Could not load scenarios." },
    "scn.denied": { ar: "ليست لديك صلاحية للسيناريوهات.", en: "You don't have permission for scenarios." },
    "scn.impactProfit": { ar: "أثر الربح", en: "Profit impact" },
    "scn.impactRevenue": { ar: "أثر المبيعات", en: "Revenue impact" },
    "scn.impactMargin": { ar: "أثر الهامش (نقطة)", en: "Margin impact (pts)" },
    "scn.insufficient": { ar: "لا توجد مبيعات لفترة الأساس — لم يُحسب السيناريو.", en: "No sales in the base period — the scenario was not calculated." },
    "scn.createCard": { ar: "أنشئ سيناريو جديداً", en: "Create a new scenario" },
    "scn.period": { ar: "فترة الأساس", en: "Base period" },
    "dm.title": { ar: "ذاكرة القرارات", en: "Decision memory" },
    "dm.similar": { ar: "قرارات سابقة مشابهة", en: "Similar past decisions" },
    "dm.none": { ar: "لا توجد قرارات سابقة مشابهة.", en: "No similar past decisions." },
    "dm.expected": { ar: "ما كان متوقعاً", en: "What was expected" },
    "dm.measured": { ar: "ما تم قياسه", en: "What was measured" },
    "dm.unknown": { ar: "ما زال غير معروف", en: "Still unknown" },
    "dm.missing": { ar: "البيانات الناقصة", en: "Missing data" },
    "dm.open": { ar: "عرض القرارات السابقة", en: "Show past decisions" },
    "dm.status.pending_measurement": { ar: "بانتظار القياس", en: "Pending measurement" },
    "dm.status.insufficient_data": { ar: "بيانات غير كافية", en: "Insufficient data" },
    "dm.status.measured": { ar: "مقاس (بيانات جزئية)", en: "Measured (partial data)" },
    "dm.status.verified": { ar: "قياس موثّق", en: "Verified measurement" },
    "dm.status.not_verified": { ar: "قياس غير صالح", en: "Not verified" },
    "dm.status.cancelled": { ar: "ملغى", en: "Cancelled" },
    "dm.reason.same_kpi": { ar: "نفس المؤشر", en: "Same KPI" },
    "dm.reason.same_problem": { ar: "نفس المشكلة", en: "Same problem" },
    "dm.reason.same_branch": { ar: "نفس الفرع", en: "Same branch" },
    "dm.reason.same_decision_type": { ar: "نفس نوع القرار", en: "Same decision type" },
    "rule.details": { ar: "التفاصيل الفنية", en: "Technical details" },
    "rule.threshold": { ar: "الحد", en: "Threshold" },
    "rule.kpi": { ar: "المؤشر المتأثر", en: "Affected KPI" },
    "rule.technical": { ar: "القاعدة", en: "Rule" },
    "rule.formula": { ar: "طريقة حساب الأثر", en: "Impact formula" },
    "rule.current": { ar: "القيمة الحالية", en: "Current value" },
    "rule.action": { ar: "الإجراء المقترح", en: "Suggested action" },
    // ---- عام / تنقّل ----
    ...
    "hr.title": { ar: "وحدة الموارد البشرية", en: "Human Resources" },
    "ops.title": { ar: "وحدة العمليات", en: "Operations" },
    "inv.title": { ar: "وحدة المخزون", en: "Inventory" },
    "proc.title": { ar: "وحدة المشتريات", en: "Procurement" },
    "sal.title": { ar: "وحدة المبيعات التفصيلية", en: "Detailed Sales" },
    "sal.sub": { ar: "تحليل شامل للمبيعات: الإيراد، النمو، متوسط الطلب، التحويل، والخصومات.", en: "Full sales analytics: revenue, growth, AOV, conversion, discounts." },
    "sal.info": { ar: "💡 كل مؤشر يُحسب من بياناتك.", en: "💡 Each metric is computed from your data." },
    "sal.entry": { ar: "إدخال بيانات المبيعات", en: "Enter Sales Data" },
    "proc.sub": { ar: "تحليل شامل للمشتريات: الإنفاق، الموردين، مخاطر التركّز، والوفورات.", en: "Full procurement analytics: spend, suppliers, concentration risk, savings." },
    "proc.info": { ar: "💡 كل مؤشر يُحسب من بياناتك.", en: "💡 Each metric is computed from your data." },
    "proc.entry": { ar: "إدخال بيانات المشتريات", en: "Enter Procurement Data" },
    "inv.sub": { ar: "تحليل شامل للمخزون: الدوران، أيام البقاء، النفاد، والأصناف بطيئة الحركة.", en: "Full inventory analytics: turnover, DIO, stockouts, slow-moving items." },
    "inv.info": { ar: "💡 كل مؤشر يُحسب من بياناتك. المؤشرات بدون بيانات تظهر بحاجة لإدخال.", en: "💡 Each metric is computed from your data." },
    "inv.entry": { ar: "إدخال بيانات المخزون", en: "Enter Inventory Data" },
    "ops.sub": { ar: "تحليل شامل للعمليات: الكفاءة، التسليم، الجودة، SLA، والطاقة.", en: "Full operations analytics: efficiency, delivery, quality, SLA, capacity." },
    "ops.info": { ar: "💡 كل مؤشر يُحسب من بياناتك. المؤشرات بدون بيانات تظهر بحاجة لإدخال.", en: "💡 Each metric is computed from your data. Missing metrics show needs input." },
    "ops.entry": { ar: "إدخال بيانات العمليات", en: "Enter Operations Data" },
    "hr.sub": { ar: "تحليل شامل للقوى العاملة: الإنتاجية، الأداء، الدوران، والرضا الوظيفي.", en: "Full workforce analytics: productivity, performance, turnover, and engagement." },
    "hr.info": { ar: "💡 كل مؤشر يُحسب من بياناتك الفعلية. المؤشرات بدون بيانات تظهر بحاجة لإدخال — وليست صفراً.", en: "💡 Each metric is computed from your actual data. Metrics without data show needs input — not zero." },
    "hr.entry": { ar: "إدخال بيانات HR", en: "Enter HR Data" },
